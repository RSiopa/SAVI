...
def main():
    ...
    np_points = np.asarray(frame.vertices)
    # np_points = np.asarray(down_point_cloud.points)
    print(np_points)
    vector_points = o3d.utility.Vector3dVector(np_points)
    bounding_box_vector = o3d.utility.Vector3dVector(vector_points)

    bounding_box = o3d.geometry.AxisAlignedBoundingBox.create_from_points(bounding_box_vector)

    table_point_cloud = o3d.geometry.PointCloud.crop(down_point_cloud, bounding_box)
