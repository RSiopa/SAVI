...
class PointCloudProcessing():
    ...
    def preProcess(self, voxel_size=0.02):
        ...
        print('Downsampling reduced point cloud from  ' + str(len(self.original.points)) + ' to ' + str(
            len(self.pcd.points)) + ' points')
    ...
    def findPlane(self, distance_threshold=0.02, ransac_n=3, num_iterations=100):
        ...
        plane_model, inlier_idxs = self.pcd.segment_plane(distance_threshold=distance_threshold, ransac_n=ransac_n,
